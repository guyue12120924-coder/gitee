(() => {
  ...
  const TASKS = {
    t2i: {
      ...
      allowAutoSync: true,
      models: [
        { id: "Qwen-Image-2512", label: "Qwen-Image-2512", badge: "推荐 · 高质量", adapter: "qwen-image", group: "recommended", status: { state: "verified", text: "已验证", detail: "Qwen 尺寸适配已确认可生成" } },
        { id: "FLUX.2-dev", label: "FLUX.2-dev", badge: "高质量 · 专业", adapter: "generic-image", group: "more" },
        { id: "Qwen-Image", label: "Qwen-Image", badge: "高质量 · 中文文字", adapter: "qwen-image", group: "recommended", status: { state: "adapted", text: "已适配", detail: "Qwen 参数适配已就绪，建议实测" } },
        ...
        { id: "z-image-turbo", label: "z-image-turbo", badge: "推荐 · 极速 · 2K", adapter: "z-image", group: "recommended", status: { state: "verified", text: "已验证", detail: "本站已确认可生成" } },
        { id: "Z-Image", label: "Z-Image", badge: "高质量", adapter: "z-image", group: "more" },
