(() => {
  ...
  hub.register("generic-video", {
    ...
    parameters: {
      i2v: [
        { key: "resolution", label: "分辨率", type: "select", sourceId: "mmI2VResolution", options: ["720P", "480P"], default: "720P" },
        { key: "ratio", label: "画面比例", type: "select", sourceId: "mmI2VRatio", options: ["16:9", "9:16", "1:1"], default: "16:9" },
        { key: "duration", label: "时长（秒）", type: "number", sourceId: "mmI2VDuration", min: 1, max: 30, step: 1, default: 5 },
      ...
      t2v: [
        ...
        { key: "resolution", label: "分辨率", type: "select", sourceId: "mmT2VResolution", options: ["720P", "480P", "1080P"], default: "720P" },
        { key: "duration", label: "时长（秒）", type: "number", sourceId: "mmT2VDuration", min: 1, max: 30, step: 1, default: 5 },
  ...
  hub.register("wan-i2v", {
    ...
    parameters: [
      ...
      { key: "resolutionPreset", label: "分辨率预设", type: "select", sourceId: "wanResPreset", options: "source" },
      { key: "width", label: "宽度", type: "number", sourceId: "wanW", min: 64, max: 2048, step: 8, default: 832 },
      { key: "height", label: "高度", type: "number", sourceId: "wanH", min: 64, max: 2048, step: 8, default: 480 },
      { key: "duration", label: "总时长（秒）", type: "number", sourceId: "wanDuration", min: 0.5, max: 60, step: 0.5, default: 5, help: "超过 5 秒时继续使用原有分段生成逻辑。" },
      { key: "seed", label: "Seed（-1=随机）", type: "number", sourceId: "wanSeed", min: -1, max: 2147483647, step: 1, default: -1 },
  ...
  hub.register("hunyuan-t2v", {
    ...
    parameters: [
      ...
      { key: "frames", label: "num_frames", type: "number", sourceId: "hyFrames", min: 81, max: 241, step: 1, default: 241 },
      { key: "seed", label: "Seed", type: "number", sourceId: "hySeed", min: 1, max: 2147483647, step: 1, default: 1 },
